          ...
          <div className="tab-content">
            ...
            <div className={`tab-panel ${activeTab === 0 ? "active" : ""}`}>
              <div className="engineers">
                ...
                <ul className="resp_duties_pera">
                  ...
                  <li>
                    Familiar with usage of various LAB instruments like
                    soldering station, multimeter etc.
                  </li>
                  ...
                  <li>
                    Candidate must have a knack to use his/her technical
                    knowledge to give it back to society.
                  </li>
                  <li>
                    Candidates must be open to work with communities to get
                    feedback on product features so that products are best fit
                    for social upliftment.
                  </li>
                  <li>
                    Must have the ability to work closely with different teams
                    to see end-to-end implementation of features/products.
                  </li>
                  <li>
                    Candidates must be open to travel to remote locations.
                  </li>
                  <li>
                    Analytical reasoning and fact-based brainstorming
                    capabilities will be highly preferred.
                  </li>
                </ul>
            ...
            <div className={`tab-panel ${activeTab === 1 ? "active" : ""}`}>
              <div className="engineers">
                ...
                <p className="resp_duties_summ">
                  The primary job would be to lead the architectural division of
                  the company. Work will be a mix of architectural and graphic
                  designing. You will be required to work on planning and
                  designing of public toilet and sewage treatment plants along
                  with various ponds and water bodies rejuvenation project.{" "}
                </p>
                ...
                <ul type="disc" className="resp_duties_summ">
                  ...
                  <li>
                    Candidate must be open to work with communities to get
                    feedback on product features so that products are best fit
                    for social upliftment.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    understanding of human-centered design and good design
                    aesthetic
                  </li>
                  <li>
                  ...
                  <li>
                    Candidate must have the ability to work closely with
                    different teams to see end-to-end implementation of
                    features/products
                  </li>
                </ul>
                <p className="resp_duties_add">
            ...
            <div className={`tab-panel ${activeTab === 2 ? "active" : ""}`}>
              <div className="engineers">
                ...
                <ul type="disc" className="resp_duties_pera">
                  <li>
                    Experience in field of embedded system designing. Any
                    experience in sanitation sector would be highly preferred.
                    Freshers with exceptional skillsets could also be
                    considered.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    micro-controllers, memories, communication interfaces,
                    op-amps, comparators, relays, inductors and capacitors,
                    Handling EMI and Noise issues associated with circuits.
                  </li>
                  <li>
                  ...
                  <li>
                    Understanding of scientific methodologies of
                    experimentation, data-gathering and interpretation and
                    hypothesis.
                  </li>
                  <li>
                  ...
                  <li>
                    Technical problem-solving skills using a systematic
                    approach.
                  </li>
                </ul>
                <p className="resp_duties_add">
            ...
            <div className={`tab-panel ${activeTab === 3 ? "active" : ""}`}>
              <div className="engineers">
                ...
                <p className="resp_duties_h">Technical Skills Needed:</p>
                <ul type="disc" className="resp_duties_pera">
                  <li>
                    Experience in field of embedded system designing. Any
                    experience in sanitation sector would be highly preferred.{" "}
                  ...
                  <li>
                    Experience with any RTOS designing preferably with FreeRTOS
                    at least with Semaphores, SW Timers, synchronisation and
                    event handlings, task handling and prioritization.
                  </li>
                  <li>
                    Understanding of micro-controller architecture, programming
                    and debugging methodologies, interrupt-handling.
                  </li>
                  <li>
                  ...
                  <li>
                    Basic understanding of assembly programing of ARM
                    architecture.
                  </li>
                  <li>
                    Understanding of basic peripherals like UART, CAN, I2C,
                    Timers, Counters, PWMs, ADCs, DAC.
                  </li>
                  <li>
                    Understanding of Ethernet, wifi-modules will be preferred.
                  </li>
                ...
                <p className="resp_duties_h">General Skills Needed:</p>
                <ul className="resp_duties_pera">
                  <li>
                    Candidate must have a knack to use his/her technical
                    knowledge to give it back to society.
                  ...
                  <li>
                    Ability to work closely with different teams to see
                    end-to-end implementation of features/products
                  </li>
                </ul>
                <p className="resp_duties_add">
                  <br />
            ...
            <div className={`tab-panel ${activeTab === 4 ? "active" : ""}`}>
              <div className="engineers">
                ...
                <ul type="disc" className="resp_duties_pera">
                  <li>
                    Experience of 1-4 years in field of embedded system
                    designing. Any experience in sanitation sector would be
                    highly preferred. Freshers with exceptional skillsets could
                    also be considered.
                  </li>
                  <li>
                    Strong fundamentals of electronics (Digital and analog) are
            ...
            <div className={`tab-panel ${activeTab === 5 ? "active" : ""}`}>
              <div className="engineers">
                <p className="resp_duties_h">Job Summary</p>
                <p className="resp_duties_summ">
                  Once the product is installed in the field, we intend to
                  monitor the performance of the system on the field. Also,
                  consumers/users might face issues <br />
                  while the system is being field tested. After-sales engineer
                  has an important role to play to successfully handle the
                  grievances reported by consumer
                  <br /> and provide resolution on the spot.
                </p>
                <p className="resp_duties_h">Responsibilities and Duties</p>
                <p className="resp_duties_h">
                  Person would be responsible for one or more of the following:
                ...
                <ol type="number" className="resp_duties_pera">
                  ...
                  <li>
                    Visiting client site to debug the issue reported by
                    consumer.
                  </li>
                  <li>Satisfactorily handling consumer grievances.</li>
                  <li>
                    Preparing the detailed report of the visit, issues faced by
                    the client and resolution taken.
                  </li>
                  <li>Understanding of the system and its components.</li>
                  <li>Testing the system on-field after grievance handling.</li>
                  <li>
                    Detailed capturing of data from the systems already
                    installed on-field.
                  </li>
                </ol>
                ...
                <ul type="disc" className="resp_duties_pera">
                  <li>
                    Experience in field of embedded system testing. Any
                    experience in sanitation sector would be highly preferred.{" "}
                  </li>
                  <li>
                    Experience in field of embedded system testing. Any
                ...
                <ul className="resp_duties_pera">
                  ...
                  <li>
                    Candidates must find associated with the cause and mission
                    of the company.
                  </li>
                  <li>
                    Open to work in open startup culture and give his/her 100%.
              ...
              <div className="engineers">
                ...
                <ol type="number" className="resp_duties_pera">
                  ...
                  <li>
                    ...
                    consultants, understanding of construction drawings,
                    execution, BBS, monitoring, progress checking, safety,
                    quality control, bill checking and payment
                  </li>
                  <li>BOQ for upcoming/ongoing project</li>
                  <li>
                    Material availability/ inhouse fabrication/ customised parts
                    and their dispatch to sites timely
                  </li>
                  <li>Finalization of layout as per site conditions</li>
                  <li>
                    Construction supervision including safety, quality control
                    and schedule management from client / owner side
                  </li>
                  <li>Softwares like Auto-Cad, SAP, Lumion/Sketch up etc.</li>
                  <li>Vendor management and follow up</li>
                  <li>
                    Presentations to government bodies/ communication during
                    project execution
                  </li>
                </ol>
              ...
              <div className="engineers">
                ...
                <ol type="number" className="resp_duties_pera">
                  ...
                  <li>
                    ...
                    and legislation are adhered to
                  </li>
                </ol>
            ...
            <div className={`tab-panel ${activeTab === 8 ? "active" : ""}`}>
              <div className="engineers">
                ...
                <ol type="number" className="resp_duties_pera">
                  <li>
                    Work with the project team to develop cost effective
                    shoring, reshoring and formwork systems for concrete
                    structures.
                  </li>
                  <li>
                  ...
                  <li>
                    Manage design process and provide direction to drafting
                    staff.
                  </li>
                  <li>
                  ...
                  <li>
                    Assists in forecasting material needs for formwork, shoring
                    and reshoring.
                  </li>
                  <li>
                    Our design system and process requires that the design
                    engineer perform some drafting duties and drawing review in
                    AutoCAD.
                    <br /> A general working knowledge of AutoCAD is helpful,
          ...
          >
            ...
            <form action="Career.jsx" id="application-form" method="post">
              <div className="form-start">
                ...
                <div className="form_check" style={{ marginTop: "10%" }}>
