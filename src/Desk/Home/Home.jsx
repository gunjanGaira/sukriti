...
const Home = () => {
  ...
  <>
    ...
    <div className='banner-img-container'>
      ...
      <p className='banner-img-b-container' ></p>
    ...
    <div>
           ...
           <p className='Baneer-text'> Sustainable creations for <span  id='banner-text' >you</span> </p>
    </div>
     

      <div class="col-md-12-text-center">
           <p class="p-text-below-banner-txt">SUKRITI is working to solve<br/>
           <ice className='two-major-factor'>two major developmental challenges of our society</ice></p>
      </div>
    ...
    <div className='outer-text-of-banner'>
      <p className='img-of-seat'>
           <img src={seat} />
           &nbsp;&nbsp;&nbsp;&nbsp; 
           Freedom from unhygienic <br />sanitation
        ...
        <p className='water-drop-image'>
            <img src={drop}/>
            &nbsp;&nbsp;&nbsp;&nbsp; 
           Rejuvenation <br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;of water bodies
    ...
    {/* section three */}
        <div class="content-Ecolet" >
            ...
            <div class="container-mt"  >
                 <div class="row" >
                    <div class="col-main-content" ><br/>
                        <div class="col-ecolats-left ">
                               <p class="heading-content"><tc >SMART PUBLIC TOILETS</tc></p>
                               <ice className='ECO'>ECOMITRA</ice>
                               
                                   <hr className='smart-public-toilet-line-container'/>
                                   
                               <div  class="elats_left" >
                                    <tc className="peracontainer1">Public toilets in India today face three major issues: a need for constant </tc>
                                    <ice className="peracontainer2">maintenance, provision of an uninterrupted water supply, and a lack of waste </ice>
                                    <ice className="peracontainer3">disposal mechanisms. With EcoMitra we’ve solved these and more:</ice>
                               ...
                               <br/>
                                ...
                                <p className="p-text5">
                                    <a href="Ecomitra"><input type="button" name="learn" value="LEARN MORE" /> </a>                                  
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="ecolats-right-left" >
                                <div class="inner-recycle-background-front-container" >
                                       <p className='background-of-recyle-water-container'>
                                           <img src={backgroundOfEcomitra} className='ineer-background-of-ecomitra-container'/>   
                                       </p>
                                                                   
                                    
                                        <p className='toilet-icon-of-recyle-water-container'>
                                            <img src= {fullImageOfToilet} className='ineer-toileticon-ecomitra-container' />
                                        </p>
                                    
                                    
                                        <p className='frontview-icon-of-recyle-water-container'>
                                            <img src= {frontView} className='ineer-frontview-ecomitra-container'/>
                                            
                                        </p> 
                                     
                                    
                                        <p className='image-icon-of-recyle-water-container'>
                                            <img src={Image} className='ineer-image-ecomitra-container'/>
                                        </p> 
                                </div>
                        ...
                        <div >
                             <div>
                                <div className="inner-recycle-background-front-container">
                                    ...
                                    <p className='background-of-recyle-water-container'>
                                        <img src={RewaterIcon} className='ineer-background-of-recyle-water-container'/>
                                    </p>
                                    <p className='river-img-container'>
                                        <img src={shiprazRiver} className='ineer-river-img-container' /><br />
                                    </p>
                                  
                                    <p className='boxes-img-container'>
                                        <br /><img src={BoxesIcon} className='ineer-boxes-img-container' />
                                    </p>

                                    <p className='river-icon-container'>
                                        <br /><img src={RiverIcon} className='ineer-river-icon-container' />
                                    </p>
                                ...
                                <div>
                                  <p className="recycle-water-heading-content">
                                    ...
                                    <p  class="elats_right" >
                                        <ice className='recycle-pera-one'>We are cleaning sewage streams and water bodies through eco-friendly</ice>
                                          <ice className='recycle-pera-two'>biological interventions.We are waging a war on Water Crisis and Water</ice>
                                          <ice className='recycle-pera-three'> Pollution with our innovative waste treatment system:</ice><br/>
                                    </p>
                                <div classna="title-of-recyle">
                                    ...
                                    <p className="inner-title-of-recyle5" >
                                          ...
                                          <a href="Rewater">  <input type="button" name="learn" value="LEARN MORE" /> 
                                          </a>                                
                                     </p>
                                </div>
                            </div>
       ...
       {/* section five */}
        ...
        <div class="achievement-container " >
                ...
                <div class="achivment-text-center" >
                        <p className="heading-content-text-uppercase" >
                                Achievements
                            </p>
                            <p class="heading-content-text-lowercase" >Our innovative & sustainable engineering, and its impactful execution<br />
                                ...
                                <div className="item-carousel-card" >
                                            ...
                                            <div className="centered-top" >
                                                 <img src={McIcon} className='image-of-mc-icon'/>
                                                    ...
                                                    <p className="pera-text-of-mc-icon">Mass Challenge, <br/> Israel</p>
                                            </div>
                                </div>
            ...
            <div class="container-fluid text-center resMedia">
                    <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                            <p class="text-center media"><span>IN THE MEDIA&nbsp;:</span> 
  ...
  {/* section six */}
    <div>
                ...
                <div className="outer-india-insitude-of-technology-banner" >
                        ...
                        <div className="conent-of-the-iit-roorkee">
                                <p className="inner-box-conent-of-the-iit-roorkee">
                                    <ice className="inner-box1-conent-of-the-iit-roorkee">IIT Roorkee is helping us with the</ice>
                                    <br/>
                                    <ice className="inner-box2-conent-of-the-iit-roorkee">development of technology for our smart</ice>
                                     <br /> 
                                     <ice className="inner-box3-conent-of-the-iit-roorkee">toilet.</ice>
            ...
            <div className='main-university-of-surrey-container'>
                           ...
                           <div className='outer-university-of-surrey-logo-container'>
                                    ...
                                    <img  src={surreyIcon} className='university-of-surrey-logo-container'/>
                            </div>
                            <div className='vertical-surrrey-line-container' />

                            <div >
                                   <p className="surrey">
                                        <ice className='surrey1'>University of Surrey, UK is helping us with the</ice> 
                                        <ice className='surrey2'>development of an efficient waste treatment </ice>
            ...
            <div className="indian-oil-outer-img-icon">
                        ...
                        <div  >
                                <img src={IconOfIndianOil} className='indian-oil-inner-img-icon'/>
                        </div>
                        ...
                        <div className='outer-main-pera-content-of-indian-oil'>
                                    ...
                                    <ice className='outer-main-pera1-content-of-indian-oil'>
                                          Indian Oil is providing us with funding and </ice> 
                                    <ice  className='outer-main-pera2-content-of-indian-oil'>
                                          mentoring for the development of smart toilet </ice>
   ...
   {/* sectionseven */}
    <div>
                  ...
                  <img src={ BackgroundContactUs} className='bakground-of-contact-us' />
                  <img src="assets/home/123.PNG" />

            <footer className='main-footer-container'>
                <div >
                      <div >
                            <div class='footer_icon' >
                                   <img src={IconOfLinkedin} className='container-of-linkedinIcon'/>
                            </div>

                            <div class='footer_icon'>
                                    <img src={IconOfFacebook} className='container-of-facebookIcon'/>
                            </div>
                            <div class='footer_icon'>
                      ...
                      <div className="old-ofice-address-container"  >
                            <p className="contact">
                                ...
                                Jhandewalan Phase 1 ,Delhi 110055, India<br/>
        
                            </p>
                      </div>
                      <div class="sukriti-Logo-Container ">
                          <img src="./assets/home/group.svg" alt="logo" />
                          <img src="./assets/home/u.png" alt="logo" />
                      </div>      
                     ...
                     <div >
                        <form action="Home.js" method="post">
                            <div class="form-group">
                                ...
                                <div>
                                  <input type="text" class="form-control contact-first-input" id="fname" name="fname" placeholder="First Name" required data-error="Please enter your name" />
                                </div>

                                <div >
                                     <input type="text" class="form-control contact-first-input" id="lname" name="lname" placeholder="Last Name" required data-error="Please enter your Last name" />
                                </div>
                            ...
                            <div>
                                  <input type="email" id="email" class="form-control" name="email" placeholder="Email address" required data-error="Please enter your email" />
                            </div>
