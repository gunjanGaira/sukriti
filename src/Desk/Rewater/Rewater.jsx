...
import Shipra_River from "../Rewater/10.png";
        ...
        <div className="inner-regenrating-container">
          <div className="icon-content">
            ...
            <p className="rewater_pera">
              <span style={{fontWeight:"650"}}>Prefabricated waste treatment unit:</span> simple and quick
          ...
          <div className="icon-content">
            ...
            <p className="rewater_pera">
              <span style={{fontWeight:"650"}}>Uses hybrid technology:</span>
          ...
          <div className="icon-content">
            ...
            <p className="rewater_pera">
              <span style={{fontWeight:"650"}}>Zero operational costs.</span>
              <br />
            </p>
          </div>
        </div>
        <div className="vidImage">
      <video poster={Shipra_River} className="rivar-imag">
          <source src={Rewater_video} type="video/mp4"/>
      </video>
        <img src={PLAY_icon} className="play_ic"/>
      </div>
      </div>
      </div>
    </div>
